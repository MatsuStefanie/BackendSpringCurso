...
import com.cristal.stefanie.cursomc.domain.*;
...
import com.cristal.stefanie.cursomc.repositores.*;
...
public class CursomcApplication implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Categoria categoria3 = new Categoria(null, "Recepção");
        Categoria categoria4 = new Categoria(null, "Almoxarifado");
        Categoria categoria5 = new Categoria(null, "Papelaria");
        Categoria categoria6 = new Categoria(null, "jardinagem");
        Categoria categoria7 = new Categoria(null, "Tesouraria");
